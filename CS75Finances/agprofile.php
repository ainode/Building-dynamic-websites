...
?>	
			   <tr>
				...
				<td><a class="news" href="news.php?symbol=<?php print(strtoupper($records["stock_symbol"])); ?>">News</a></td>
			   </tr>
<?php
		             }
...
?>
	...
	<div id="selldiv" style="display:none">
		<form name="sellform" action="sell.php" method="post" onsubmit="return validate_sell();">
